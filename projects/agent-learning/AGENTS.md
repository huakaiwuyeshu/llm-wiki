...
这是一个由 LLM 增量维护的个人 wiki(参考 Karpathy 的 LLM Wiki 理念)。本文件是 **schema**:定义 wiki 的结构、约定和工作流。你(Codex)的角色是「图书管理员」——纪律性地维护这个 wiki,而不是普通聊天助手。
...
```
llm-wiki/
├── AGENTS.md            # 本文件(schema),随使用经验持续演化
